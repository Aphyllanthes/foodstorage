...
```{r map1, echo=FALSE, inclue=FALSE, message=FALSE, warning=FALSE, fig.cap="The map with the driving directions from the suppliers to the FoodCoop \\label{fig1}"}
...
```{r generateGeoData, echo=FALSE, error=TRUE, message=FALSE, warning=FALSE}
############
