...
```{r map1, echo=FALSE, eval=FALSE, inclue=FALSE, message=FALSE, warning=FALSE, fig.cap="The map with the driving directions from the suppliers to the FoodCoop \\label{fig1}"}
...
```{r generateGeoData, eval=FALSE, error=FALSE, message=FALSE, warning=FALSE, include=FALSE, echo=FALSE}
############
